...
CREATE TABLE `Character_DATA` (
    ...
    `PlayerUID` VARCHAR(20) DEFAULT '' NOT NULL,
    `Alive` smallint DEFAULT '1' NOT NULL,
    `InstanceID` smallint NOT NULL,
    `Worldspace` VARCHAR(128) DEFAULT '[]' NOT NULL,
    `Inventory` text NOT NULL,
    `Backpack` text NOT NULL,
    `Medical` VARCHAR(300) DEFAULT '[]' NOT NULL,
    ...
    `DistanceFoot` bigint DEFAULT '0' NOT NULL,
    `Duration` integer DEFAULT 0 NOT NULL,
    `CurrentState` VARCHAR(128) DEFAULT '[]' NOT NULL,
    `KillsH` integer DEFAULT 0 NOT NULL,
    `KillsB` integer DEFAULT 0 NOT NULL,
    `Model` VARCHAR(50) DEFAULT 'Survivor1_DZ' NOT NULL,
    `Datetime` DATETIME
);
...
CREATE TABLE `Object_classes` (
    `Classname` VARCHAR(32) DEFAULT '' NOT NULL,
    `Chance` VARCHAR(4) DEFAULT '0' NOT NULL,
    `MaxNum` smallint DEFAULT '0' NOT NULL,
    `Damage` VARCHAR(20) DEFAULT '0' NOT NULL,
    `Hitpoints` VARCHAR(999) DEFAULT '[]' NOT NULL
);
...
CREATE TABLE `Object_spawns` (
    `ObjectUID` VARCHAR(20) DEFAULT '' NOT NULL,
    `Classname` VARCHAR(32) DEFAULT NULL,
    `Worldspace` VARCHAR(64) DEFAULT NULL,
...
CREATE TABLE character_data_dead (
    ...
    `InstanceID` smallint NOT NULL,
    `Worldspace` VARCHAR(128) DEFAULT '[]',
    `Inventory` text NOT NULL,
    `Backpack` text NOT NULL,
    `Medical` VARCHAR(300) DEFAULT '[]',
    `Generation` integer DEFAULT 0 NOT NULL,
    `Datestamp` DATETIME,
    `LastLogin` DATETIME,
    `LastAte` DATETIME,
    ...
    `KillsZ` integer DEFAULT 0 NOT NULL,
    `HeadshotsZ` integer DEFAULT 0 NOT NULL,
    `distanceFoot` bigint DEFAULT '0',
    duration integer DEFAULT 0 NOT NULL,
    `currentState` VARCHAR(128) DEFAULT '[]',
    `KillsH` integer DEFAULT 0 NOT NULL,
    `KillsB` integer DEFAULT 0 NOT NULL,
    `Model` VARCHAR(50) DEFAULT 'Survivor1_DZ',
    `Datetime` DATETIME
);
